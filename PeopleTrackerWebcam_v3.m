...
%% Setup
% Create objects for detecting people, tracking points, acquiring and
...
%set(SerPIC,'BytesAvailableFcnCount', 2); % Se configura en nº de bytes que debe haber en el buffer de recepción para disparar el evento Rx_Callback
...
% track a person. The loop will run for 400 frames or until the video player
% window is closed.
